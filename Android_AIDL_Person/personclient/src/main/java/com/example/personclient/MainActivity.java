...
import com.example.ai.aidl.IMyAidlInterface;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        String name=mEditNum1.getText().toString();
        int age=Integer.parseInt(mEditNum2.getText().toString());


        try {
            ArrayList<Person> persons=(ArrayList<Person>)iMyAidlInterface.add(new Person(name,age));

            mEditResult.setText(persons.toString());
    ...
    private void bindService() {
        ...
        intent.setComponent(new
                ComponentName("com.example.ai.aidl","com.example.ai.aidl.IRemoteService"));
